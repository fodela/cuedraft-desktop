    ...
    <div className="flex flex-col h-full overflow-hidden">
          ...
          {templates.length === 0 ? (
            ...
            templates.map((t, i) => (
              ...
              >
                ...
                <div className="text-sm text-t1 font-mono">
      ...
      <div className="grid grid-cols-2 gap-4 px-8 pb-4 shrink-0">
        <div className="bg-surface rounded-xl border border-low p-5">
          <h3 className="text-[10px] font-bold tracking-widest uppercase text-t3 mb-4">
            Global Shortcuts
          </h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                {parseHotkey(hotkey).map((k, i, arr) => (
                  <span key={k} className="flex items-center gap-1">
                    <kbd className="px-2 py-1 text-xs bg-raised text-accent rounded border border-low">
                      {k}
                    </kbd>
                    {i < arr.length - 1 && (
                      <span className="text-t4 text-xs">+</span>
